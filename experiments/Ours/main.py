...
from model.our_model import NonlinearCauCAModel
import torch
import numpy as np
import random
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["linear", "nonlinear", "volumepreserving", "nonvolumepreserving"],
    )
    parser.add_argument(
        "--scm",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="GPU index when accelerator=gpu (ignored for cpu).",
    )
    ...
    if args.mode == "synthetic":
        ...
        selected_idx =  DGP[args.dgp]["selected_idx"]
        observed_idx = DGP[args.dgp]["observed_idx"]
        n_blocks = DGP[args.dgp]["num_blocks"]
        block_dims = DGP[args.dgp]["block_dims"]
    elif args.mode == "flow":
